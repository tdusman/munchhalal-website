import { Restaurant, Ad, Signup, ContactSubmission, SiteSettings } from '@/types';
...
export function getAdByPlacement(placement: Ad['placement']): Ad | undefined {
  return getAds().find((a) => a.placement === placement && a.status === 'active');
}
...
export function initSeedData(): void {
  ...
  const restaurants: Restaurant[] = [
    // TORONTO (5)
    {
      ...
      description: 'Authentic Pakistani cuisine in the heart of Toronto. Known for our signature seekh kebabs, butter chicken, and fresh naan bread baked in our traditional tandoor oven. Family-owned since 2005, we serve halal-certified dishes made with the freshest ingredients.',
      category: 'Pakistani',
      ...
      socialLinks: { instagram: 'https://instagram.com/lahoretikka', facebook: 'https://facebook.com/lahoretikkahouse' },
      images: [
    ...
    },
    {
      ...
      description: 'Experience the finest Middle Eastern cuisine at Paramount Fine Foods. Our menu features shawarma, falafel, grilled meats, and traditional Lebanese desserts. Every dish is prepared with premium halal-certified ingredients and authentic recipes passed down through generations.',
      category: 'Lebanese',
      ...
      socialLinks: { instagram: 'https://instagram.com/paramountfinefoods', facebook: 'https://facebook.com/paramountfinefoods', twitter: 'https://twitter.com/paramountfoods' },
      images: [
    ...
    },
    {
      ...
      name: 'Mogadishu Eats',
      slug: 'mogadishu-eats',
      description: 'Toronto\'s premier Somali restaurant bringing the vibrant flavors of East Africa to your table. Enjoy our aromatic basmati rice with tender goat suqaar, sambusa platters, and refreshing mango lassi. Halal and family friendly.',
      category: 'Somali',
      cuisineType: 'Somali',
    ...
    },
    {
      ...
      description: 'A celebration of Indian street food and fine dining in downtown Toronto. From crispy pani puri to creamy butter paneer, our chefs craft each dish with traditional spices and modern flair. Fully halal kitchen with vegetarian options available.',
      category: 'Indian',
      cuisineType: 'Indian',
      ...
      socialLinks: { instagram: 'https://instagram.com/bombaychowpatty', facebook: 'https://facebook.com/bombaychowpatty' },
      images: [
    ...
    },
    {
      ...
      description: 'Sultan Kebab Palace offers the finest Turkish and Mediterranean cuisine in Toronto. Savor our charcoal-grilled Adana kebabs, authentic doner wraps, and creamy hummus platters. Our meats are sourced from certified halal suppliers.',
      category: 'Turkish',
      cuisineType: 'Turkish',
      ...
      socialLinks: { instagram: 'https://instagram.com/sultankebab', twitter: 'https://twitter.com/sultankebab' },
      images: [
    ...
    // MISSISSAUGA (3)
    {
      ...
      description: 'Al-Tanoor Grill is Mississauga\'s go-to destination for authentic Middle Eastern grilled meats and fresh salads. Our tanoor oven produces perfectly charred flatbreads while our chefs prepare juicy shawarma and mixed grills daily.',
      ...
      socialLinks: { instagram: 'https://instagram.com/altanoor', facebook: 'https://facebook.com/altanoor' },
      images: [
    ...
    },
    {
      ...
      description: 'Bringing the bold flavors of Karachi street food to Mississauga. Try our famous nihari, haleem, and biryani prepared with slow-cooked spices. A family-friendly restaurant with generous portions and warm hospitality.',
      category: 'Pakistani',
      cuisineType: 'Pakistani',
    ...
    },
    {
      ...
      name: 'Saffron Lounge',
      slug: 'saffron-lounge',
      description: 'Saffron Lounge combines elegant Indian dining with a modern twist. Our menu features aromatic biryanis, tandoori specialties, and signature curry bowls. Perfect for family gatherings or a special night out in Mississauga.',
      category: 'Indian',
      cuisineType: 'Indian',
      ...
      socialLinks: { instagram: 'https://instagram.com/saffronlounge', facebook: 'https://facebook.com/saffronlounge' },
      images: [
    ...
    // BRAMPTON (3)
    {
      ...
      description: 'Experience the rich flavors of Afghan cuisine at Kabul Farms. Our specialties include mantu dumplings, chopan kabob, and fragrant qabuli palaw. Every dish is prepared with authentic spices and halal meats, served in a warm and inviting atmosphere.',
      category: 'Afghan',
      cuisineType: 'Afghan',
    ...
    },
    {
      ...
      description: 'Brampton\'s authentic Bangladeshi dining experience. Our chefs serve traditional dishes like kacchi biryani, fish bhuna, and shatkora beef curry. We use family recipes that have been perfected over decades, with 100% halal ingredients.',
      ...
      socialLinks: { instagram: 'https://instagram.com/dhakaspice', facebook: 'https://facebook.com/dhakaspice' },
      images: [
    ...
    },
    {
      ...
      description: 'A Turkish culinary gem in Brampton offering fresh pide, lahmacun, and charcoal-grilled kebabs. Our desserts include traditional baklava and kunefe. All meats are halal certified and sourced from trusted local suppliers.',
      category: 'Turkish',
      cuisineType: 'Turkish',
    ...
    // SCARBOROUGH (2)
    {
      ...
      description: 'Discover the rich and aromatic flavors of Somalia at Suugo. Our menu features traditional bariis iskukaris, hilib ari, and freshly made canjeero. A community favorite in Scarborough for over a decade, serving 100% halal food.',
      category: 'Somali',
      cuisineType: 'Somali',
    ...
    },
    {
      ...
      name: 'Naan & Chai',
      slug: 'naan-and-chai',
      description: 'Naan & Chai is Scarborough\'s beloved Pakistani-Indian fusion restaurant. From butter chicken poutine to tandoori pizza, we blend traditional South Asian flavors with Canadian favorites. Our chai bar offers 12 unique tea blends.',
      category: 'Pakistani',
      cuisineType: 'Pakistani',
      ...
      socialLinks: { instagram: 'https://instagram.com/naanandchai', facebook: 'https://facebook.com/naanandchai', twitter: 'https://twitter.com/naanandchai' },
      images: [
    ...
    // OTTAWA (2)
    {
      ...
      description: 'Ottawa\'s top-rated shawarma spot! We serve massive platters of juicy chicken and beef shawarma with garlic sauce, fresh tabbouleh, and fluffy rice. Voted Best Shawarma in Ottawa three years running. Halal certified by ISNA Canada.',
      category: 'Lebanese',
      cuisineType: 'Lebanese',
      ...
      socialLinks: { instagram: 'https://instagram.com/shawarmastation', facebook: 'https://facebook.com/shawarmastation' },
      images: [
    ...
    },
    {
      ...
      description: 'A taste of Lebanon in Canada\'s capital. Beirut Star Grill offers mezze platters, charcoal-grilled kafta, and fresh fattoush salad. Our cozy atmosphere and generous portions make us a favorite among Ottawa\'s halal food lovers.',
      category: 'Middle Eastern',
      cuisineType: 'Middle Eastern',
      address: '370 Bank St',
      city: 'Ottawa',
      ...
      socialLinks: { instagram: 'https://instagram.com/beirutstar', facebook: 'https://facebook.com/beirutstar' },
      images: [
